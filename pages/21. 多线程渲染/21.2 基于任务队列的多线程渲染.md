...
```c++
//file:render_task_consumer.h line:16
...
```c++
//file:render_task_consumer.h line:48
...
主线程中实例化`RenderTaskConsumer`后，在`RenderTaskConsumer`的构造函数中就创建了渲染线程。

```c++
//file:render_task_consumer.cpp line:13
...
```c++
//file:render_task_consumer.h line:90
