...
public:
    ...
    static void MapShaderProgram(unsigned int shader_program_handle, unsigned int shader_program_id){
    ...
    /// \param vao_handle
    /// \param vao_id
    static void MapVAO(unsigned int vao_handle, unsigned int vao_id){
    ...
    /// \param shader_program_handle
    /// \return
    static unsigned int GetShaderProgram(unsigned int shader_program_handle){
    ...
    /// \param vao_handle
    /// \return
    static unsigned int GetVAO(unsigned int vao_handle){
