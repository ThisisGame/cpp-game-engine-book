...
void PointLight::set_color(glm::vec3 color){
    ...
    std::string uniform_block_member_name=fmt::format("array_data[{}].color",light_id_);
...
void PointLight::set_intensity(float intensity){
    ...
    std::string uniform_block_member_name=fmt::format("array_data[{}].intensity",light_id_);
...
void PointLight::set_attenuation_constant(float attenuation_constant){
    ...
    std::string uniform_block_member_name=fmt::format("array_data[{}].constant",light_id_);
...
void PointLight::set_attenuation_linear(float attenuation_linear){
    ...
    std::string uniform_block_member_name=fmt::format("array_data[{}].linear",light_id_);
...
void PointLight::set_attenuation_quadratic(float attenuation_quadratic){
    ...
    std::string uniform_block_member_name=fmt::format("array_data[{}].quadratic",light_id_);
...
void PointLight::Update(){
    ...
    std::string uniform_block_member_name=fmt::format("array_data[{}].pos",light_id_);
