...
void Environment::set_ambient_color(const glm::vec3 &ambient_color) {
    ...
    UniformBufferObjectManager::UpdateUniformBlockSubData3f("AmbientBlock","data.color",ambient_color_);
}
...
void Environment::set_ambient_color_intensity(float ambient_color_intensity){
    ...
    UniformBufferObjectManager::UpdateUniformBlockSubData1f("AmbientBlock","data.intensity",ambient_color_intensity_);
}