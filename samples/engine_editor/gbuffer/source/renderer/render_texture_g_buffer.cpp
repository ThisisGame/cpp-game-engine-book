...
#include "render_texture_g_buffer.h"
#include "renderer/texture_2d.h"
#include "render_device/gpu_resource_mapper.h"
#include "render_device/render_task_producer.h"

RenderTextureForGBuffer::RenderTextureForGBuffer(): width_(128), height_(128), frame_buffer_object_handle_(0),in_use_(false),
                                color_texture_2d_(nullptr),depth_texture_2d_(nullptr) {
}

RenderTextureForGBuffer::~RenderTextureForGBuffer() {
...
void RenderTextureForGBuffer::Init(unsigned short width, unsigned short height) {
    width_=width;
    height_=height;
