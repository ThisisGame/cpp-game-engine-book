...
void NoiseTexture::Init(unsigned short width, unsigned short height) {
    width_=width;
    height_=height;
    noise_texture_2d_=Texture2D::Create(width_, height_, GL_RGB, GL_RGB, GL_UNSIGNED_SHORT_5_6_5, nullptr, 0);
}
