...
//                                      "event_instance",&AudioStudioEvent::event_instance,
    ...
    // component
    {
        cpp_ns_table.new_usertype<Tree::Node>("Node",sol::call_constructor,sol::constructors<Tree::Node()>(),
                                             "parent",&Tree::Node::parent,
                                             "children",&Tree::Node::children,
                                             "AddChild",&Tree::Node::AddChild,
                                             "RemoveChild",&Tree::Node::RemoveChild,
        ...
        cpp_ns_table.new_usertype<Transform>("Transform",sol::call_constructor,sol::constructors<Transform()>(),
                                           ...
                                           "set_local_position", &Transform::set_local_position,
                                           "set_local_rotation", &Transform::set_local_rotation,
                                           "set_local_scale", &Transform::set_local_scale,
    ...
    // renderer
    {
        ...
        cpp_ns_table.new_usertype<RenderTextureGeometryBuffer>("RenderTextureGeometryBuffer", sol::call_constructor, sol::constructors<RenderTextureGeometryBuffer()>(),
                                                               ...
                                                               "frag_position_texture_2d", &RenderTextureGeometryBuffer::frag_position_texture_2d,
                                                               "frag_normal_texture_2d", &RenderTextureGeometryBuffer::frag_normal_texture_2d,
                                                               "frag_vertex_color_texture_2d", &RenderTextureGeometryBuffer::frag_vertex_color_texture_2d,
